...
class Registration extends Component {
  ...
  onSubmit() {
    ...
    if (
      ...
      !attendee.firstName ? this.setState({
        firstNameRequired: true
      }) : null;
      !attendee.lastName ? this.setState({
        lastNameRequired: true
      }) : null;
      !attendee.event ? this.setState({
        eventRequired: true
      }) : null;
      !validContact && attendee.contact ?
        ...
        null;
      !attendee.profileName ? this.setState({
      ...
      !attendee.contact ?
        ...
        null;
      invalidProfileUrl ? this.setState({
        invalidProfileUrl: true
      }) : null;
    }
  }
  ...
  render() {
    ...
    return this.state.loading ? ( <
      ...
      onKeyPress = {
        e => this.setInputToNumeric(e)
      }
      value = {
        Registration.contact
      }
      required = {
        this.state.contactRequired
      }
      onchanged = {
        event => this.onChangeInput(event)
      }
      ...
      /Col> <
      /FormGroup> <
      RegistrationModal openFlag = {
        this.state.displayPasswordFlag
      }
      toggleFunction = {
